...
export function DialogTrigger({
  ...
  return (
    <DialogPrimitive.Trigger
      className={mergeStateClassName("ds-dialog-trigger", className)}
      {...props}
    />
  );
}
    ...
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Viewport className={cn("ds-dialog-viewport", viewportClassName)}>
        <DialogPrimitive.Popup
          className={mergeStateClassName("ds-dialog-content", className)}
          {...props}
        >
          {children}
        </DialogPrimitive.Popup>
...
export function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title className={mergeStateClassName("ds-dialog-title", className)} {...props} />
  );
}
...
export function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      className={mergeStateClassName("ds-dialog-description", className)}
      {...props}
    />
  );
}
...
export function DialogClose({
  ...
  return (
    <DialogPrimitive.Close className={mergeStateClassName("ds-dialog-close", className)} {...props} />
  );
}
