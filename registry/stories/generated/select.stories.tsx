...
const item = registry.items.find((entry) => entry.name === "select") as RegistryStoryItem;
const playground = playgrounds["select"];

const meta = {
  title: "Registry/Components/Select",
...
export const Playground: Story = {
  render: (args) => <ComponentPreview name="select" props={args} />
};
