...
const item = registry.items.find((entry) => entry.name === "radio-group") as RegistryStoryItem;
const playground = playgrounds["radio-group"];

const meta = {
  title: "Registry/Company UI/Radio Group",
...
export const Playground: Story = {
  render: (args) => <ComponentPreview name="radio-group" props={args} />
};
