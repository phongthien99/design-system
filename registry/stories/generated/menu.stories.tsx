...
const item = registry.items.find((entry) => entry.name === "menu") as RegistryStoryItem;
const playground = playgrounds["menu"];

const meta = {
  title: "Registry/Company UI/Menu",
...
export const Playground: Story = {
  render: (args) => <ComponentPreview name="menu" props={args} />
};
