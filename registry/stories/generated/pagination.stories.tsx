...
const item = registry.items.find((entry) => entry.name === "pagination") as RegistryStoryItem;
const playground = playgrounds.pagination;

const meta = {
  title: "Registry/Composites/Pagination",
...
export const Playground: Story = {
  render: (args) => <ComponentPreview name="pagination" props={args} />
};
