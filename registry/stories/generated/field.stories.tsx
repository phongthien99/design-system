...
const item = registry.items.find((entry) => entry.name === "field") as RegistryStoryItem;
const playground = playgrounds["field"];

const meta = {
  title: "Registry/Company UI/Field",
...
export const Playground: Story = {
  render: (args) => <ComponentPreview name="field" props={args} />
};
