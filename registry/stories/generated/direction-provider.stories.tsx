...
const item = registry.items.find((entry) => entry.name === "direction-provider") as RegistryStoryItem;
...
export const Playground: Story = {
  render: (args) => <ComponentPreview name="direction-provider" props={args} />
};
