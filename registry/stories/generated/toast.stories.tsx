...
const item = registry.items.find((entry) => entry.name === "toast") as RegistryStoryItem;
const playground = playgrounds["toast"];

const meta = {
  title: "Registry/Company UI/Toast",
...
export const Playground: Story = {
  render: (args) => <ComponentPreview name="toast" props={args} />
};
