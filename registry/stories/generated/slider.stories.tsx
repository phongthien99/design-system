...
const item = registry.items.find((entry) => entry.name === "slider") as RegistryStoryItem;
const playground = playgrounds["slider"];

const meta = {
  title: "Registry/Company UI/Slider",
...
export const Playground: Story = {
  render: (args) => <ComponentPreview name="slider" props={args} />
};
