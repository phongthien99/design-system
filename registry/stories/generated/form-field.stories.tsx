...
const item = registry.items.find((entry) => entry.name === "form-field") as RegistryStoryItem;
const playground = playgrounds["form-field"];

const meta = {
  title: "Registry/Company UI/Form Field",
...
export const Playground: Story = {
  render: (args) => <ComponentPreview name="form-field" props={args} />
};
