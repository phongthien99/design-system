...
const item = registry.items.find((entry) => entry.name === "menubar") as RegistryStoryItem;
const playground = playgrounds["menubar"];

const meta = {
  title: "Registry/Company UI/Menubar",
...
export const Playground: Story = {
  render: (args) => <ComponentPreview name="menubar" props={args} />
};
