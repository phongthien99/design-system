...
const item = registry.items.find((entry) => entry.name === "progress") as RegistryStoryItem;
const playground = playgrounds["progress"];

const meta = {
  title: "Registry/Company UI/Progress",
...
export const Playground: Story = {
  render: (args) => <ComponentPreview name="progress" props={args} />
};
