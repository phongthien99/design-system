...
const item = registry.items.find((entry) => entry.name === "table") as RegistryStoryItem;
const playground = playgrounds.table;

const meta = {
  title: "Registry/Components/Table",
...
export const Playground: Story = {
  render: () => <ComponentPreview name="table" />
};
