...
const item = registry.items.find((entry) => entry.name === "meter") as RegistryStoryItem;
const playground = playgrounds["meter"];

const meta = {
  title: "Registry/Primitives/Meter",
...
export const Playground: Story = {
  render: (args) => <ComponentPreview name="meter" props={args} />
};
