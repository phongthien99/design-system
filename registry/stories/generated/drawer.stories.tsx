...
const item = registry.items.find((entry) => entry.name === "drawer") as RegistryStoryItem;
const playground = playgrounds["drawer"];

const meta = {
  title: "Registry/Company UI/Drawer",
...
export const Playground: Story = {
  render: (args) => <ComponentPreview name="drawer" props={args} />
};
