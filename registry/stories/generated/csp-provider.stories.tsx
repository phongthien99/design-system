...
const item = registry.items.find((entry) => entry.name === "csp-provider") as RegistryStoryItem;
const playground = playgrounds["csp-provider"];

const meta = {
  title: "Registry/Components/Csp Provider",
...
export const Playground: Story = {
  render: (args) => <ComponentPreview name="csp-provider" props={args} />
};
