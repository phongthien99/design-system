...
const item = registry.items.find((entry) => entry.name === "fieldset") as RegistryStoryItem;
const playground = playgrounds["fieldset"];

const meta = {
  title: "Registry/Components/Fieldset",
...
export const Playground: Story = {
  render: (args) => <ComponentPreview name="fieldset" props={args} />
};
