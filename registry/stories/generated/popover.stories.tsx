...
const item = registry.items.find((entry) => entry.name === "popover") as RegistryStoryItem;
const playground = playgrounds["popover"];

const meta = {
  title: "Registry/Company UI/Popover",
...
export const Playground: Story = {
  render: (args) => <ComponentPreview name="popover" props={args} />
};
